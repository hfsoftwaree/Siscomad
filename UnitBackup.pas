...
uses UnitDM, UnitPrincipal, Unitskin;

{$R *.dfm}
Procedure Tfrmbackup.ValidarBasedeDados1;
 ...
 with IBBackupService1 do
  begin
    ...
    try
      ...
      BackupFile.Add(deBackup.Text+'/'+ mskvalor.Text + 'siscomad.gbk');
      ServiceStart;
      While not Eof do
...
begin
febanco.Text := removechar(febanco.Text );
end;

...
begin
	if TOTALM3.Value > SALDO.Value then
   	begin
         Application.MessageBox('Total M/3, maior que saldo disponivel, Verifique!', 'Lançamento', mb_Ok + mb_IconInformation);
         QUANTIDADE.SetFocus;
    end;
    end;
    end;
...
begin
        ...
        DM.TPRODUCAO.Filtered := False;
        DM.TPRODUCAO.Close;
        DM.TPRODUCAO.Filter := 'CODIGOESSENCIA = ' + (DBEDIT5.Text) + 'and CODPRODUTO = ' + (DBEdit9.Text);

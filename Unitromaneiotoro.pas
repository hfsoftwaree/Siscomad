...
procedure TfrmRomaneiotoro.BitBtn3Click(Sender: TObject);
begin
g.Caption := 'Produtos ';
    fornecedor.Text := '';
    inscricao.Text := '';
   ...
   valtotal.Caption  := '';
    ...
    BitBtn11.Enabled := false;
      ...
      DM.TROMANEIOTORO.Filtered := False;
      DM.TROMANEIOTORO.Close;
      DM.QCredor.Close;
      DM.QEssencia.Close;
close;
end;

procedure TfrmRomaneiotoro.BitBtn5Click(Sender: TObject);
begin
DM.QCredor.Open;
...
procedure TfrmRomaneiotoro.BitBtn2Click(Sender: TObject);
begin
...
procedure TfrmRomaneiotoro.BitBtn12Click(Sender: TObject);
begin
   DM.TROMANEIOTORO.Filtered := False;
   DM.TROMANEIOTORO.Close;
   DM.TROMANEIOTORO.Filter := 'NF = ' + QuotedStr(nota.Text)+ ' and CODEMPRESA = ' + QuotedStr(edit1.Text);
   DM.TROMANEIOTORO.Filtered := True;
DM.TROMANEIOTORO.Open;
DM.TROMANEIOTORO.Append;
frmRomaneiotorosprodutos.Show;
frmRomaneiotorosprodutos.DBEDIT1.SetFocus;
end;
...
procedure TfrmRomaneiotoro.BitBtn9Click(Sender: TObject);
var total, total1 : Real;
begin
If Application.MessageBox('Deseja Excluir esse produto?', 'Confirmação',
mb_YesNo + mb_ICONQUESTION) = idYes then
begin
   DM.TROMANEIOTORO.Delete;
   g.Caption := 'Produtos > ' + intTostr(DM.TROMANEIOTORO.RecordCount);
   total := 0;
   total1 := 0;
   ...
   DM.TROMANEIOTORO.Prior;
   while not DM.TROMANEIOTORO.Eof do
     begin
        total := DM.TROMANEIOTORO['VLTOTAL'] + total ;
        total1 := DM.TROMANEIOTORO['TOTALM3'] + total1 ;
        DM.TROMANEIOTORO.Next;
     end;
...
procedure TfrmRomaneiotoro.BitBtn10Click(Sender: TObject);
begin
DM.TROMANEIOTORO.Next;
end;

procedure TfrmRomaneiotoro.BitBtn11Click(Sender: TObject);
begin
DM.TROMANEIOTORO.Prior;
end;
...
procedure TfrmRomaneiotoro.BitBtn4Click(Sender: TObject);
begin
  DM.QManutencao.Open;
...
procedure TfrmRomaneiotoro.BitBtn7Click(Sender: TObject);
begin
DM.TROMANEIOTORO.EDIT;
frmRomaneiotorosprodutos.Show;
frmRomaneiotorosprodutos.DBEDIT1.SetFocus;
end;
...
procedure TfrmRomaneiotoro.BitBtn6Click(Sender: TObject);
var total, total1 : Real;
begin
...
begin
    ...
    frmromaneioserrada.g.Caption := 'Produtos > ' + intTostr(DM.TROMANEIOTORO.RecordCount);
    DM.TROMANEIOTORO.close;
    fornecedor.Text := '';
    inscricao.Text := '';
    edit1.Text := '';
...
procedure TfrmRomaneiotoro.notaExit(Sender: TObject);
var total, total1 : Real;
begin
   DM.TROMANEIOTORO.Filtered := False;
   DM.TROMANEIOTORO.Close;

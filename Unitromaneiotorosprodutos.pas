...
begin
   ...
   frmromaneioTORO.editfax.Text := frmromaneioTORO.edit1.Text;
    DM.TROMANEIOTORO.Post;
   frmromaneioTORO.g.Caption := 'Produtos > ' + intTostr(DM.TROMANEIOTORO.RecordCount);
...
procedure TfrmRomaneiotorosprodutos.FormClose(Sender: TObject;
  var Action: TCloseAction);
var total, total1 : Real;
begin
   DM.TROMANEIOTORO.Filtered := False;
   DM.TROMANEIOTORO.Close;
   DM.TROMANEIOTORO.Filter := 'NF = ' + QuotedStr(frmromaneioTORO.nota.Text)+ ' and CODEMPRESA = ' + QuotedStr(frmromaneioTORO.edit1.Text);
...
begin
   ...
   begin
   frmromaneioTORO.BitBtn9.Enabled := True;
   frmromaneioTORO.BitBtn10.Enabled := True;
   frmromaneioTORO.BitBtn11.Enabled := True;
   frmromaneioTORO.BitBtn7.Enabled := True;   
   ...
   while not DM.TROMANEIOTORO.Eof do
    ...
    frmromaneioTORO.valtotal.Caption  := FormatCurr('#0.00',total);
    frmromaneioTORO.m3.Caption  := FormatCurr('#0.0000',total1);
    frmromaneioTORO.bitbtn5.Enabled := True;
    frmromaneioTORO.bitbtn3.Enabled := True;
    frmromaneioTORO.bitbtn4.Enabled := True;
    frmromaneioTORO.BitBtn3.SetFocus;
   end;
end;
end;

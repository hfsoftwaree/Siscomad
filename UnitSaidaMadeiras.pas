...
procedure TfrmSaidaMadeiras.BitBtn5Click(Sender: TObject);
begin
DM.QSaida.Open;
...
procedure TfrmSaidaMadeiras.BitBtn8Click(Sender: TObject);
begin
...
procedure TfrmSaidaMadeiras.BitBtn6Click(Sender: TObject);
begin
DM.QSaida.Close;
DM.QSaida.Open;
if DM.QSaida.RecordCount = 0 then
...
procedure TfrmSaidaMadeiras.BitBtn13Click(Sender: TObject);
begin
if DM.TSaida1.RecordCount = 0 then
begin

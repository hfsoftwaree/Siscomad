...
begin
  ...
  RepEntrada2.TENTRADA.Filter := 'DATA_EMISSAO >= ' + QuotedStr(DataInicial.Text) + ' and DATA_EMISSAO <= ' + QuotedStr(DataFinal.Text);
...
begin
RepEntrada2.TENTRADA.IndexFieldNames := 'NF_NUMERO';
...
begin
RepEntrada2.TENTRADA.IndexFieldNames := 'DATA_EMISSAO';
RepEntrada2.PI.Caption := DataInicial1.text;
RepEntrada2.PF.Caption := DataFinal1.text;
RepEntrada2.QuickRep1.Preview;
end
...
begin
RepEntrada2.TENTRADA.IndexFieldNames := 'RAZAO_SOCIAL';
RepEntrada2.PI.Caption := DataInicial1.text;
RepEntrada2.PF.Caption := DataFinal1.text;
RepEntrada2.QuickRep1.Preview;
end;

...
uses UnitLogin, UnitDM, UnitPrincipal, Unitskin;
type
...
Procedure Tfrmconfigbd.ValidarBasedeDados1;
...
Reg.OpenKey('Software\HF Softwares\Siscomad', true);
...
Reg.Free;
      ...
      begin
        if fileexists('C:\HF-Software\Siscomad\Siscomad.exe') then
        begin
        Application.Terminate;
        ExecutePrograma('C:\HF-Software\Siscomad\Siscomad.exe','');
        end
        else
        begin
...
begin
panel1.Lines.Text := 'Informe o nome do SERVIDOR ou endereço IP onde esta localizado o Banco de Dados, Ex: 192.168.0.1, em caso de duvidas entre em contato com o administrador da rede ou do sistema.';
end;

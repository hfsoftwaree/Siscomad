...
procedure TRepEntrada1.QRGroup1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
vlsub:= 0;
vlsub1:= 0;
...
procedure TRepEntrada1.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TRepEntrada1.QRBand5BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin

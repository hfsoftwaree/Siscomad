...
begin
      ...
      frmEntradaSerrada.DBEDIT1.Text := DM.QFornecedor['CNPJ'];
      frmEntradaSerrada.inscricao.Text := DM.QFornecedor['INSCESTADUAL'];
...
begin
if frmEntradaToros.Tag = 1 then
begin
      frmEntradaToros.fornecedor.Text := DM.QFornecedor['NOMEFORNECEDOR'];
      frmEntradaToros.DBEDIT1.Text := DM.QFornecedor['CPF'];
      frmEntradaToros.inscricao.Text := DM.QFornecedor['INSCESTADUAL'];
      frmEntradaToros.DBEdit6.Text := DM.QFornecedor['CODIGOFORNECEDOR'];
      Close;
      frmEntradaToros.nota.SetFocus;
      end
      else
begin
...
begin
if frmFunRural.Tag = 1 then
begin
      frmFunRural.FORNECEDOR.Text := DM.QFornecedor['NOMEFORNECEDOR'];
      frmFunrural.essencia.Text := DM.QFornecedor['CODIGOFORNECEDOR'];
      Close;
      frmFunrural.bitbtn3.SetFocus;
      end
      else
begin
...
begin
      frmRRomaneiotoros.fornecedor.Text := DM.QFornecedor['NOMEFORNECEDOR'];
      frmRRomaneiotoros.EDIT1.Text := DM.QFornecedor['CODIGOFORNECEDOR'];
      Close;
...
if frmRomaneiotoro.Tag = 1 then
begin
      frmRomaneiotoro.fornecedor.Text := DM.Qfornecedor['NOMEFORNECEDOR'];
      frmRomaneiotoro.inscricao.Text := DM.Qfornecedor['INSCESTADUAL'];
      frmRomaneiotoro.edit1.Text := DM.Qfornecedor['CODIGOFORNECEDOR'];
